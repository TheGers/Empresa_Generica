              ...
              <div class="row">
                ...
                <div class="col-md-4">
                    ...
                    <div class="row">
                        ...
                        <div class="form-group col-md-6">
                            <label class="control-label">FECHA_CREACION <span class="required">*</span></label>
                            <input class="form-control" id="txtFECHA_CREACION" name="txtFECHA_CREACION" type="text" required="">
                        </div>
                        <div class="form-group col-md-6">
                            <label class="control-label">MODIFICADO_POR <span class="required">*</span></label>
                            <input class="form-control" id="txtMODIFICADO_POR" name="txtMODIFICADO_POR" type="text" required="">
                        </div>
                        <div class="form-group col-md-6">
